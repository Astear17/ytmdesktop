...
onMounted(() => {
  ...
  // Material You / Accent Color support
...
<template>
  ...
  <Suspense>
    <TitleBar is-main-window has-home-button has-settings-button has-minimize-button has-maximize-button :title="$t('app_window_title')" :icon-file="logo" />
  </Suspense>
  <Suspense>
    <YTMViewLoading />
  </Suspense>
